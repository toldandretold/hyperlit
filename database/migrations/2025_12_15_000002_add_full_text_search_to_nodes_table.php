...
return new class extends Migration
{
    ...
    {
        DB::connection('pgsql_admin')->statement('DROP INDEX IF EXISTS nodes_search_vector_idx');
        DB::connection('pgsql_admin')->statement('ALTER TABLE nodes DROP COLUMN IF EXISTS search_vector');
    }
};
