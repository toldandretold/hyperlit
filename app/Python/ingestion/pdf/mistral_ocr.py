...
# Human-readable notes for the function-based recovery / fidelity stages — same `plain` convention as
# the classifier/assembler classes, attached here (after all four are defined) so the notes generator
# + the LLM failure report can read one source. These are the REC1/REC2/REC3 + FID tree nodes.
