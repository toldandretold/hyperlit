            ...
            [
                ...
                'substages' => [
                    [
                        ...
                        'code_ref' => 'app/Services/CitationReview/Phases/CitationParser.php::parseCitationNodes',
                    ],
                    [
                        'id'       => 'enrich',
                        ...
                        'code_ref' => 'app/Services/CitationReview/Phases/MetadataEnricher.php::enrichCitationMetadata',
                    ],
                    [
                        'id'       => 'extract',
                    ...
                    [
                        ...
                        'code_ref' => 'app/Services/CitationReview/Phases/PassageSearcher.php::searchSourcePassages',
                    ],
                    [
                        'id'       => 'verify',
                        ...
                        'code_ref' => 'app/Services/CitationReview/Phases/ClaimVerifier.php::verifyClaims',
                    ],
                    [
                        'id'       => 'highlights',
                        ...
                        'code_ref' => 'app/Services/CitationReview/Phases/VerificationHighlighter.php::createVerificationHighlights',
                    ],
                    [
                        'id'       => 'report',
                        'title'    => 'Building report',
                        'plain'    => 'Assembles the full markdown report — verdict charts, provenance, per-claim evidence, pipeline diagnostics.',
                        'code_ref' => 'app/Services/CitationReview/Report/ReportBuilder.php::buildMarkdownReport',
                    ],
                    [
                        'id'       => 'import',
                        'title'    => 'Publishing report',
                        'plain'    => 'Imports the report as a sub-book at /{book}/AIreview and emails you a summary.',
                        'code_ref' => 'app/Services/CitationReview/Import/ReportSubBookImporter.php::importReportAsSubBook',
                    ],
                ],
            ],
        ];
