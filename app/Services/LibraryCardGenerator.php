...
class LibraryCardGenerator
{
     ...
     */
    public function generateLibraryCardChunk($record, string $bookName, int $positionId, bool $isOwner, bool $isEmpty = false, int $index = 0, string $visibility = 'public'): array
    {
        $now = Carbon::now();
     ...
     */
    public function generateLibraryCardHtml($record, int $positionId, bool $isOwner, string $nodeId): string
    {
