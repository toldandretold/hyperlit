...
| `checkEditPermissionsAndUpdateUI` | `components/editButton/lock` | — | — | read/write | — |
...
| `aboutBookContainer` | `components/userProfile/userAboutBook` | — | — | read | — |
| `aboutBookId` | `components/userProfile/userAboutBook` | — | — | — | — |
| `enterAboutEdit` | `components/userProfile/userAboutBook` | — | — | read/write | — |
| `exitAboutEdit` | `components/userProfile/userAboutBook` | — | — | write | — |
| `hydrateAboutBook` | `components/userProfile/userAboutBook` | — | — | read/write | — |
| `isAboutEditing` | `components/userProfile/userAboutBook` | — | — | — | — |
...
| `ContainerCustomizer.sanitizeCustomizations` | `components/utilities/containerCustomization` | — | — | — | — |
...
| `hasKnownPosition` | `hyperlights/myHighlights/list` | `nodes` | — | — | — |
...
| `__clearSentSyncTokensForTests` | `indexedDB/syncQueue/sentSyncTokens` | — | `localStorage` | — | — |
| `generateSyncToken` | `indexedDB/syncQueue/sentSyncTokens` | — | — | — | — |
| `hasSentSyncToken` | `indexedDB/syncQueue/sentSyncTokens` | `localStorage` | — | — | — |
| `recordSentSyncToken` | `indexedDB/syncQueue/sentSyncTokens` | `localStorage` | `localStorage` | — | — |
| `__resetUnloadOnceGuardForTests` | `indexedDB/syncQueue/unload` | — | — | — | — |
...
| `asChunkId` | `indexedDB/types` | — | — | — | — |
| `isBookId` | `indexedDB/types` | — | — | — | — |
| `isChunkId` | `indexedDB/types` | — | — | — | — |
| `parseChunkId` | `indexedDB/types` | — | — | — | — |
...
| `LinkNavigationHandler.domMatchesUrl` | `SPA/navigation/LinkNavigationHandler` | — | — | read | — |
...
- `components/userProfile/userAboutBook` → `divEditor/imageDrop/index`
- `components/userProfile/userAboutBook` → `divEditor/index`
- `components/userProfile/userAboutBook` → `editToolbar/index`
- `components/userProfile/userAboutBook` → `hyperlights/index`
- `components/userProfile/userAboutBook` → `hyperlitContainer/editMode`
- `components/userProfile/userAboutBook` → `indexedDB/hydration/rebuild`
- `components/userProfile/userAboutBook` → `indexedDB/index`
- `components/userProfile/userAboutBook` → `indexedDB/syncQueue/master`
- `components/userProfile/userAboutBook` → `lazyLoader/chunkRender`
- `components/userProfile/userAboutBook` → `paste/index`
- `components/userProfile/userPageEditor` → `components/userProfile/userAboutBook`
