 ...
 */
const EXTRA_ROOTS = [path.join(RES_ROOT, 'e2ee'), path.join(RES_ROOT, 'paste'), path.join(RES_ROOT, 'search'), path.join(RES_ROOT, 'hyperlights'), path.join(RES_ROOT, 'hypercites'), path.join(RES_ROOT, 'divEditor'), path.join(RES_ROOT, 'editToolbar'), path.join(RES_ROOT, 'footnotes'), path.join(RES_ROOT, 'citations'), path.join(RES_ROOT, 'hyperlitContainer'), path.join(RES_ROOT, 'lazyLoader'), path.join(RES_ROOT, 'scrolling'), path.join(RES_ROOT, 'pageLoad'), path.join(RES_ROOT, 'SPA'), path.join(RES_ROOT, 'components', 'cloudRef'), path.join(RES_ROOT, 'components', 'sourceContainer'), path.join(RES_ROOT, 'components', 'userButton'), path.join(RES_ROOT, 'components', 'userContainer'), path.join(RES_ROOT, 'components', 'newBookButton'), path.join(RES_ROOT, 'components', 'newbookContainer'), path.join(RES_ROOT, 'components', 'openbookButton'), path.join(RES_ROOT, 'components', 'openbookContainer'), path.join(RES_ROOT, 'components', 'settingsButton'), path.join(RES_ROOT, 'components', 'settingsContainer'), path.join(RES_ROOT, 'components', 'editButton'), path.join(RES_ROOT, 'components', 'tocToggleButton'), path.join(RES_ROOT, 'components', 'tocContainer'), path.join(RES_ROOT, 'components', 'utilities'), path.join(RES_ROOT, 'components', 'logoNav'), path.join(RES_ROOT, 'components', 'homepage'), path.join(RES_ROOT, 'components', 'userProfile'), path.join(RES_ROOT, 'components', 'fileDropTarget'), path.join(RES_ROOT, 'components', 'floatingActionMenu'), path.join(RES_ROOT, 'components', 'saveErrorToast'), path.join(RES_ROOT, 'components', 'togglePerimeterButtons'), path.join(RES_ROOT, 'components', 'containerDragger'), path.join(RES_ROOT, 'components', 'selectionHandler'), path.join(RES_ROOT, 'components', 'toast'), path.join(RES_ROOT, 'components', 'shelves')];
