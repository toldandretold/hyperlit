...
vi.mock('../../../resources/js/utilities/cacheState.js', () => ({ markCacheDirty: vi.fn() }));
vi.mock('../../../resources/js/utilities/chunkLoadingState.js', () => ({ clearChunkLoadingInProgress: vi.fn() }));
vi.mock('../../../resources/js/search/inTextSearch/searchToolbar.js', () => ({ invalidateSearchIndex: vi.fn() }));
vi.mock('../../../resources/js/utilities/BroadcastListener.js', () => ({ TAB_ID: 'test-tab', markBookEditedLocally: vi.fn() }));
