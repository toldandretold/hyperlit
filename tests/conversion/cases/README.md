...
8. **Hand back to the human**: they deploy, press ↻ reconvert on `/maintainer`, and resolve the flag (`php artisan library:reconvert-queue --resolve=<book> --resolution=reconverted` on prod).
