...
- Name: tests/e2e/specs/citations/citation-modal-mobile.spec.js >> Citation modal — mobile viewport >> panel itself has non-zero rendered height on mobile open
- Location: tests/e2e/specs/citations/citation-modal-mobile.spec.js:63:3
