...
- Name: tests/e2e/specs/citations/citation-modal-mobile.spec.js >> Citation modal — mobile viewport >> REAL touch on Shelf chip fires the scope change (no preventDefault eating the click)
- Location: tests/e2e/specs/citations/citation-modal-mobile.spec.js:88:3
