...
- Name: tests/e2e/specs/citations/citation-modal-mobile.spec.js >> Citation modal — mobile viewport >> DIAGNOSTIC: focusout from input → select inside citation mode must NOT trigger adjustLayout(false)
- Location: tests/e2e/specs/citations/citation-modal-mobile.spec.js:270:3
