...
- Name: tests/e2e/specs/citations/citation-modal-mobile.spec.js >> Citation modal — mobile viewport >> DIAGNOSTIC: keyboard-open scenario — shelf focus must keep citation mode open AND not trigger keyboard layout reset
- Location: tests/e2e/specs/citations/citation-modal-mobile.spec.js:196:3
