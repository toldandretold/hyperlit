...
- Name: tests/e2e/specs/citations/citation-modal-mobile.spec.js >> Citation modal — mobile viewport >> chip bar is inside the visible viewport rect
- Location: tests/e2e/specs/citations/citation-modal-mobile.spec.js:50:3
