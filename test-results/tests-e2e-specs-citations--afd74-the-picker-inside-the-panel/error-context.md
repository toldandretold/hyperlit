...
- Name: tests/e2e/specs/citations/citation-modal-mobile.spec.js >> Citation modal — mobile viewport >> tapping Shelf without keyboard reveals the picker inside the panel
- Location: tests/e2e/specs/citations/citation-modal-mobile.spec.js:70:3
