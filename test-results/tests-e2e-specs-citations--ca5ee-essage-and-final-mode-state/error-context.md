...
- Name: tests/e2e/specs/citations/citation-modal-mobile.spec.js >> Citation modal — mobile viewport >> DIAGNOSTIC: tap shelf select — capture every console message and final mode state
- Location: tests/e2e/specs/citations/citation-modal-mobile.spec.js:335:3
