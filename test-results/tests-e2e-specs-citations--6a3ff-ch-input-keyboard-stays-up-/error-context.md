...
- Name: tests/e2e/specs/citations/citation-modal-mobile.spec.js >> Citation modal — mobile viewport >> tapping a chip does NOT blur the search input (keyboard stays up)
- Location: tests/e2e/specs/citations/citation-modal-mobile.spec.js:104:3
