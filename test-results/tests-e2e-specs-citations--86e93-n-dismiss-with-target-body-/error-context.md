...
- Name: tests/e2e/specs/citations/citation-modal-mobile.spec.js >> Citation modal — mobile viewport >> DIAGNOSTIC: simulate the EXACT iOS event sequence (picker open + dismiss with target=body)
- Location: tests/e2e/specs/citations/citation-modal-mobile.spec.js:121:3
