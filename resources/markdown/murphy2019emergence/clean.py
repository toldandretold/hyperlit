...
# Define the paths for the original and parsed files
text_folder = 'epub_original/text'
...
def parse_html_file(file_path, parsed_folder):
    with open(file_path, 'r', encoding='utf-8') as f:
        ...
        # Append a <br> tag manually
        final_content.append(soup.new_tag('br'))
...
# Parse through all files in the text folder
