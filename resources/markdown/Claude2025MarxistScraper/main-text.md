...
I have already done something _like_ this using Vanilla JS  for the Hypertext Editor, which is intialised within

  
  As it is intialised as an instance within
