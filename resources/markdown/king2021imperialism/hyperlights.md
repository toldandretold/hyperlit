...
> "British Library"
> [↩](http://localhost:8000/king2021imperialism#user-name_1733374336237)
...
> "development myth"
> [↩](http://localhost:8000/king2021imperialism#user-name_1733374676007)
...
> "the idea the"
> [↩](http://localhost:8000/king2021imperialism#user-name_1733183167329)


change to: "the idea that the"
...
> [↩](http://localhost:8000/king2021imperialism#user-name_1733183615682)


Definition: monopoly vs non-monopoly capital / countries



---

> "the huge gap between the small club of imperialist states and the vast majority of poor states has persisted and grown, even as the Third World has contributed an increasing share of global labour"
> [↩](http://localhost:8000/king2021imperialism#user-name_1733183743038)
...
> [↩](http://localhost:8000/king2021imperialism#user-name_1733183780108)


\*\*Nkrumah in reverse:\*\* Nkrumah thought non-aligned third world action would challenge imperialism. When the third world project was defeated, imperialism grew in strength.



---

> "Yet Lenin’s *Imperialism* – and in particular its key concept, monopoly finance capital – appears to provide a usable framework."
> [↩](http://localhost:8000/king2021imperialism#user-name_1733183869413)


Agree. good to quote. As King has shown, Lenin's \*Imperialism\*, understood as the stage of capital dominated by monopoly finance capital, is a 'usable framework'. In this article, I extend this work of King by showing that, it is quite impossible to understand global knowledge production without it.
...
> [↩](http://localhost:8000/king2021imperialism#user-name_1733184006579)
...
> [↩](http://localhost:8000/king2021imperialism#user-name_1733184045357)


Useful to pair with Robert W. Cox' idea of different 'forms of state'.



---

> "The key theoretical insight of this book – the development of the concept of non-monopoly capital – is shown to be a necessary component and theoretical extension of Lenin’s broader theory of monopoly finance capital."
> [↩](http://localhost:8000/king2021imperialism#user-name_1733184111705)
...
> "as well as the uneven and exploitative relationship between them"
> [↩](http://localhost:8000/king2021imperialism#user-name_1733184136554)


Good. Need to bring in Trotsky uneven and combined development I think.



---

> "However, much of the research, conforming to mainstream views on development, tends to view exploitative relationships as temporary or incidental, and not systemic."
> [↩](http://localhost:8000/king2021imperialism#user-name_1733184187928)
...
> "Building on this basic Marxist definition, the rest of this book shows how imperialism’s labour process monopoly constitutes the basis of its domination, exploitation and – under capitalism – its permanence."
> [↩](http://localhost:8000/king2021imperialism#user-name_1733184210108)


Labour process monopoly is the most essential - or core - monopoly.
...
> [↩](http://localhost:8000/king2021imperialism#user-name_1733184275800)


\*Perfect:\* Need \*better\* tech. As Marx argued, socialism must out compete monopoly capital at its own game.



---

> "Imperialism’s stranglehold can be broken only by decisively surpassing it technologically, by defeating the incumbent monopolies and replacing the imperialist societies as the driver of world development"
> [↩](http://localhost:8000/king2021imperialism#user-name_1733184453793)


Question: How? Can it be surpassed sector by sector? Or will struggle in one sector trigger a global crackdown? Most likely the latter, unless the sector is unimportant to profits (wikipedia). That's where the NIEO is needed, a world order initiated by non-monopoly capitalist states, will allow for a more "orderly" transition from one hegemony to the next. It could help reduce the power of monopoly capitalist elites to quash resistance against monopoly capital in a particular sector in a non-monopoly capital state. For example, by legitimising state sovereignty of national resources, and the rejection of intellectual property rights.



---

> "The reason these punitive sanctions were effective, or even possible, is because of the already existing US and broader imperialist domination in the production of the products the sanctions effected – otherwise China could simply work around them."
> [↩](http://localhost:8000/king2021imperialism#user-name_1733184699378)


A key point King makes. Its more than IP regimes. Even without IP regimes, US would still have monopoly of labour process.
...
> [↩](http://localhost:8000/king2021imperialism#user-name_1733184804327)


True. So resistance must come from within the sectors of scientific knowledge, as well as from without. This relation was key to Nkrumah.
...
> [↩](http://localhost:8000/king2021imperialism#user-name_1733184860237)


But, this imperialist system can be reformed. Just as there are "many capitals" and "many capitalist forms of state", there are different possible imperialisms. In some, economic development in the periphery, non-monopoly sectors, is relatively more easy.
...
> [↩](http://localhost:8000/king2021imperialism#user-name_1733184962782)
...
> "There is no possibility of Third World catch-up under capitalism"
> [↩](http://localhost:8000/king2021imperialism#user-name_1733185027435)
...
> "It is the sort of ‘catch-up’ that leaves one further behind – not unlike having coffee with your manager"
> [↩](http://localhost:8000/king2021imperialism#user-name_1733187567902)
...
> "As suggested, competition from imperialist capital bears down on higher-income Third World economies,preventing them from raising income – the ‘middle-income trap’ appears to be alive and well."
> [↩](http://localhost:8000/king2021imperialism#user-name_1733198781272)
...
> [↩](http://localhost:8000/king2021imperialism#user-name_1733198809711)
