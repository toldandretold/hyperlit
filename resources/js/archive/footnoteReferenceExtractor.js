// footnoteReferenceExtractor.js - SIMPLIFIED VERSION
// Orchestrates footnote/reference processing and handles database persistence
// Extraction logic has been moved to format-specific processors in resources/js/paste/

import { openDatabase } from './indexedDB.js';
import { GeneralProcessor } from './paste/format-processors/general-processor.js';
...
export async function processContentForFootnotesAndReferences(htmlContent, bookId, isHTMLContent = false, formatType = 'general') {
  console.log('🔍 [LEGACY] Processing content via fallback orchestrator...');
...
export { generateReferenceKeys } from './paste/utils/reference-key-generator.js';
export { processInTextCitations } from './paste/utils/citation-linker.js';
export { processFootnoteReferences } from './paste/utils/footnote-linker.js';
export { preprocessHTMLContent, isRealLink } from './paste/utils/html-preprocessor.js';
