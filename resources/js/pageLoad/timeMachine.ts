...
const realBook = (window as any).realBook;

export async function initializeTimeMachine() {
  const timestamp = (window as any).timeMachineTimestamp;
...
function renderBanner(timestamp: any) {
...
async function handleRestore(timestamp: any) {
