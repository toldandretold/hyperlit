...
// formatting, and the visibility-state SVG icons. Zero imports from sibling
...
// Encrypted = the private padlock with three asterisks scrawled across its body,
// signalling the content itself is scrambled (E2EE). Asterisk glyphs sit high in
// most fonts, so the baseline y is dropped to ~20 to land them on the body midline.
export const ENCRYPTED_SVG = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--color-danger)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  <rect x="3" y="11" width="18" height="11" rx="2" ry="2"/>
  <path d="M7 11V7a5 5 0 0 1 10 0v4"/>
