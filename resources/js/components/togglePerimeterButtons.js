  ...
  */
  ...
  if (
    event.target.closest(
      "#logoNavWrapper, #logoContainer, #userButton, #newBook, #editButton, #toc-toggle-button, #settingsButton, #cloudRef, .custom-alert, .custom-alert-overlay, #hyperlit-container, #ref-overlay",
    )
  ) {
    return true;
  }
