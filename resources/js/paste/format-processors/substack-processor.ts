...
export class SubstackProcessor extends BaseFormatProcessor {
  ...
  async extractFootnotes(dom: any, bookId: any) {
    ...
    footnoteAnchors.forEach((anchor: any) => {
    ...
    footnoteContents.forEach((container: any) => {
      let footnoteNum: any = null;
      ...
      clone.querySelectorAll('a[href*="#footnote-anchor-"]').forEach((el: any) => el.remove());
    ...
    footnoteWrappers.forEach((el: any) => {
  ...
  async transformStructure(dom: any, bookId: any) {
    ...
    dom.querySelectorAll('[data-component-name]').forEach((el: any) => {
    ...
    dom.querySelectorAll('.footnote-anchor').forEach((el: any) => {
