...
export class BaseFormatProcessor {
   ...
   */
  async process(htmlContent: any, bookId: any) {
   ...
   * @returns {Promise<{html: string, footnotes: Array, references: Array, formatType: string}>}
   */
  async processLite(htmlContent: any, bookId: any) {
  ...
  cleanup(dom: any) {
    ...
    const spans = Array.from<any>(dom.querySelectorAll('span'));
   ...
   */
  appendStaticSections(dom: any, footnotes: any, references: any) {
   ...
   */
  async extractFootnotes(dom: any, bookId: any): Promise<any> {
   ...
   */
  async extractReferences(dom: any, bookId: any): Promise<any> {
   ...
   */
  async transformStructure(dom: any, bookId: any): Promise<any> {
   ...
   */
  generateFootnoteId(bookId: any, identifier: any) {
   ...
   */
  generateFootnoteRefId(footnoteId: any, ...rest: any[]) {
   ...
   */
  createFootnote(footnoteId: any, content: any, originalIdentifier: any, refId: any, type: any) {
    return {
      footnoteId,
      content,
   ...
   */
  createReference(referenceId: any, content: any, originalText: any, type: any, refKeys: any[] = []) {
    return {
      referenceId,
      content,
      originalText,
