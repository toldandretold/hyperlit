...
let vacuumOverlay: any = null;
let vacuumBar: any = null;
let vacuumStatus: any = null;
let vacuumDetail: any = null;
...
function updateVacuumProgress(percent: any, status: any, detail: any) {
...
function showConfirmDialog(url: any) {
...
async function fetchChapterList(url: any) {
...
async function fetchChapter(url: any) {
 ...
 */
export async function handleNovelVacuum(url: any, targetBookId: any, isSubBook: any) {
  ...
  try {
    ...
    const { ProgressOverlayConductor } = await import('../../SPA/navigation/ProgressOverlayConductor');
