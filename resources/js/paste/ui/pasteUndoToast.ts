...
function buildSummaryText(cs: any) {
  const parts: any[] = [];
...
/* ── main export ──────────────────────────────────────────── */
export function showPasteUndoToast(onUndo: any, conversionSummary: any = {}) {
...
function renderInitialState(toast: any, onUndo: any, cs: any) {
  toast.innerHTML = '';
...
function renderThankYouState(toast: any, onUndo: any) {
  toast.innerHTML = '';
