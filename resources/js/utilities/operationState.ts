...
export function setKeyboardLayoutInProgress(value: any) {
...
export function setUndoRedoInProgress(value: any) {
...
export function setKeyboardWasRecentlyClosed(value: any) {
 ...
 */
export function setUnloadWarningActive(value: any) {
 ...
 */
export function setHandleHypercitePaste(value: any) {
 ...
 * @returns {Promise<any>}
 */
export async function withPending(fn: any) {
  try {
...
export function setCurrentObservedChunk(chunk: any) {
  currentObservedChunk = chunk;
  return chunk;
}
// Function to update the flag
export function setChunkOverflowInProgress(value: any) {
  chunkOverflowInProgress = value;
  return value;
}
// Function to update renumbering flag
export function setRenumberingInProgress(value: any) {
  renumberingInProgress = value;
  return value;
}
// Function to update user deletion flag
export function setUserDeletionInProgress(value: any) {
  userDeletionInProgress = value;
  return value;
}


export function setProgrammaticUpdateInProgress(isUpdating: any) {
...
export function setPasteInProgress(value: any) {
...
export function addNewlyCreatedHighlight(highlightId: any) {
...
export function isNewlyCreatedHighlight(highlightId: any) {
  return newlyCreatedHighlights.has(highlightId);
}

export function removeNewlyCreatedHighlight(highlightId: any) {
...
export function setSkipScrollRestoration(value: any) {
...
export function setPerimeterButtonsHidden(value: any) {
