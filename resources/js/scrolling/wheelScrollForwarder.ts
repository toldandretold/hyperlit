...
const SCROLLABLE_OVERLAY_SEL =
  '.search-results, #newbook-container, #toc-container, #user-container, #openbook-container, #source-container, #archive-container, #citation-toolbar-results, .shelf-preview-overlay, #money-overlay, #stats-overlay, #user-page-edit-panel, #shelf-picker-dropdown, .library-filter-dropdown, .integrity-overlay, .cite-group-popover, .import-queue-panel, .vibe-gallery, .add-to-shelf-menu';
