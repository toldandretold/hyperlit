...
{{-- Journal home page (/j/{slug}): the homepage's lava-lamp hero scoped to one
     ...
     tests/Feature/JournalRegistry/JournalPageTest.php):
       ...
       - The three feed buttons are visitor-shelf-tabs (data-filter="shelf")
         ...
         — the journal's articles, no per-journal pseudo-books.
       ...
       - The crawlable SEO body is the .welcome-copy section (journal about copy). --}}
...
<div id="app-container" class="lava-lamp-background">
  ...
  @include('partials.archive-ref', ['archiveScopeType' => 'journal', 'archiveScopeId' => $journal->slug])
  ...
  <div class="home-content-wrapper journal-content-wrapper">
    ...
    {{-- Journal about copy: rides .welcome-copy's scroll-reveal machinery.
