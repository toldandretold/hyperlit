...
<div id="app-container">
  ...
  {{-- Tab order = visual reading order (WCAG 2.4.3): top-left logo cluster,
       then this top-right cloudRef — it sits here in the DOM (position:fixed,
       so placement is visually free), BEFORE the content. --}}
...
<div id="word-count-display" style="display: none;"></div>
  ...
  <!-- Audio player pill — appears only while TTS audio is playing or
       ...
       A dotted grip (drag to move the pill, double-click to reset — see
       playerDrag.ts) beside a stack of two rows: info
       (counter/speed/highlight/follow/stale) over transport. The grip is NOT
       .audio-playback-only, so the pill stays movable while generating. -->
  <div id="audio-player-bar">
    <button type="button" id="audio-drag-handle" class="audio-drag-handle"
            aria-label="Move the audio player — drag, or use the arrow keys. Double-click to reset."
            title="Drag to move · double-click to reset">
      <svg viewBox="0 0 6 22" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
        ...
        <circle cx="1.5" cy="19" r="1" /><circle cx="4.5" cy="19" r="1" />
      </svg>
    </button>
    <div class="audio-pill-stack">
      <div class="audio-pill-row audio-pill-info">
      ...
      <div class="audio-pill-row audio-pill-transport">
        <button type="button" id="audio-restart" class="audio-playback-only" aria-label="Restart from top of book">
          <svg viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <line x1="5" y1="5" x2="5" y2="19" />
            <polygon points="13 5 5 12 13 19 13 5" />
            <polygon points="20 5 12 12 20 19 20 5" />
          </svg>
        </button>
        <button type="button" id="audio-prev" class="audio-playback-only" aria-label="Previous paragraph">
          <svg viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <line x1="7" y1="6" x2="7" y2="18" />
            <polygon points="18 6 9 12 18 18 18 6" />
          </svg>
        </button>
        ...
        <button type="button" id="audio-next" class="audio-playback-only" aria-label="Next paragraph">
          <svg viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <polygon points="6 6 15 12 6 18 6 6" />
