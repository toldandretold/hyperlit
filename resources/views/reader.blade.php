...
<div id="hyperlight-buttons" style="display: none; position: absolute; z-index: 9999;">
  ...
  <div id="bottom-up-container" class="hidden">
    ...
    <div class="settings-row settings-theme-row">
      <button type="button" id="darkModeButton" class="settings-button active">Dark Mode</button>
      <button type="button" id="lightModeButton" class="settings-button">Light Mode</button>
      <button type="button" id="sepiaModeButton" class="settings-button">Sepia Mode</button>
