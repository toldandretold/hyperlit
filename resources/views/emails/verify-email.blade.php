                ...
                <table role="presentation" width="500" cellpadding="0" cellspacing="0" style="max-width: 500px; width: 100%; background-color: #2A2A2A; border-radius: 12px;">
                    ...
                    <tr>
                        <td style="padding: 0 40px 28px; color: #CBCCCC; font-size: 15px; line-height: 1.6; text-align: center;">
                            Thanks for signing up for Hyperlit! Click the button below to verify your email address.
                        </td>
                    </tr>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="border-radius: 8px; background-color: #4EACAE;">
                                        <a href="{{ $verificationUrl }}" target="_blank" style="display: inline-block; padding: 14px 36px; font-family: Inter, Arial, Helvetica, sans-serif; font-size: 15px; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 8px;">
                                            Verify Email
                                        </a>
                                    </td>
                                </tr>
