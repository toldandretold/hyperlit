{{--
  The selection toolbar's brain button (#brain-hyperlight) — lives inside
  #hyperlight-buttons. Present on the reader (inline there) and, since the
  AI-answer renders became annotatable, on the hero pages too (home /
  journal-home / archive-home): hyperlights/selectionToolbar.ts hard-errors
  when it's missing. Lucide "brain", same paths as reader.blade.php's copy.
--}}
