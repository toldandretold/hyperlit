...
<div id="app-container" class="lava-lamp-background">
  ...
  <div class="home-content-wrapper">
    ...
    <section class="welcome-copy" aria-label="What is Hyperlit?">
      ...
      <h2>4. While reading: 
        <ul>
          <li>click the cloud-ref button <svg id="cloudRef-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 503.23 309.68" width="36" height="36" preserveAspectRatio="xMidYMid meet">
          ...
          <li>Select text to create a highlight, copy text for a hypercite, or consult the AI Archivist</li>
